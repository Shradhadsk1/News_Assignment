...
Original file is located at
    https://colab.research.google.com/drive/1qD6VF5kzY8Cjhn3JMkoVgZ-YKP0RYQjc
"""

import gradio as gr

def fetch_and_process_news(company_name, query=""):
    """
    ...
    for article in filtered_articles:
        ...
        results.append(f"📰 {article['title']} | Sentiment: {sentiment} | [Read More]({article['link']})")
...
iface = gr.Interface(
    ...
    description="Enter a company name to fetch news, analyze sentiment, compare news coverage, and search specific topics."
)
